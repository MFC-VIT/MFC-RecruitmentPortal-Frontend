    ...
    <b-row align-h="center" align-v="center">
      <b-col cols="10">
        ...
        <div v-for="item in this.questions" :key="item.question_id">
          ...
          <textarea
            rows="5"
            class="site-uiux-ta m-2 px-5 py-4"
            :id="item.question_id"
...
export default {
  ...
  methods: {
    ...
    async sendAnswers() {
      ...
      this.$store.dispatch("getUIUX").catch(err => {
        console.log(err);
      });
      // eslint-disable-next-line
      return new Promise((resolve, reject) => {
        getAPI
          .post(
            "https://mfcrecruitment.herokuapp.com/api/send_uiux_responses/",
            this.answers
          )
          // eslint-disable-next-line
          .then(response => {
  ...
  beforeMount() {
    ...
    return new Promise((resolve, reject) => {
      getAPI
        .get("https://mfcrecruitment.herokuapp.com/api/uiuxquestions/")
        .then(response => {
